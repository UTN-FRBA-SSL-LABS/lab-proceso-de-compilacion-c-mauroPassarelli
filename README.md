...
> **R:Porque el preprocesador copia el contenido compelto de los headers y expande macros
...
> **R:Porque el preporcesador elimina los comentarios antes de la compilacion
...
> **R:Comunican numero de linea y el archivo. Proviene del archivo stdio.h
...
> **R:Hacen la operacion suma y reservan espacio en pila
...
> **R:Porque en programa.o no esta definido y en matematica.o si
...
> **R:Porque pertenecen a bibliotecas dinámicas. Los resuelve el cargador dinámico en tiempo de ejecución.
---
...
> **R:La macro funcion (CUADRADO) es una sustitucion de texto, desaparece en el preprocesamiento y no hay verificacion de tipos. En cambio, la funcion real (sumar) es un bloque de codigo, desaparece en el enlazado y tiene verificacion de tipos
...
> **R:Un simbolo T son instrucciones y viven en la seccion .text, mientras que uno de tipo D son variables globales inicializadas y vive en la seccion .data
